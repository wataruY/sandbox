...
Theorem sort_minimum a l : Sorted (a :: l) -> Minimum _ Le a (a :: l).
...
Theorem permuted_in a l l' : In a l -> Permuted l l' -> In a l'.
...
Theorem permuted_minimum c l l' : Minimum _ Le c l -> Permuted l l' -> Minimum _ Le c l'.
intros Hmin Hperm.
inversion Hmin.
constructor.
